# packaging-provenance-e2e

Status: **contract-only**. This suite specifies immutable dependency resolution, checksums, software bills of materials, and artifact provenance.
